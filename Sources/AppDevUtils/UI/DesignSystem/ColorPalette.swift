...
public extension Color {
  enum DS {
    ...
    enum Text {
      public static var base = Color(DynamicColor(hexString: "#FFFFFF"))
      public static var subdued = Color(DynamicColor(hexString: "#afb0b6"))
      public static var accent = Color(DynamicColor(hexString: "#fb3d02"))
      public static var accentAlt = Color(DynamicColor(hexString: "#FFFFFF"))
      public static var error = Color(DynamicColor.systemRed)
      public static var success = Color(DynamicColor.systemGreen)
      public static var warning = Color(DynamicColor.systemOrange)
      public static var link = Color(DynamicColor.systemBlue)
